...
| Upstream / CI | Apache PR tip `246b5eb5541` contains CM33 NSH and clocks; fork CI passed clock tip `d4ba1324ff6` | PR-tip host build/checkpatch; FRDM hardware proof at `d4ba1324ff6` | PR remains draft `[WIP]`; XIP and Ethernet are deliberately excluded |
