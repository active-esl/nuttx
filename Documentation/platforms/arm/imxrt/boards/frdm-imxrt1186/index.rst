...
The port does not yet contain a ROM-bootable FlexSPI image.  Applications that
run for 24 hours or longer must also provide the periodic ELE active-timer ping
required by the RT1180 security reference manual.
